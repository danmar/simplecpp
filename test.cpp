...
static std::string preprocess(const char code[], std::size_t size, const simplecpp::DUI &dui, simplecpp::OutputList * const outputList, std::list<simplecpp::MacroUsage> * const macroUsage = nullptr, std::list<simplecpp::IfCond> * const ifCond = nullptr, const std::string &file = std::string())
{
    std::vector<std::string> files;
...
static std::string preprocess(const char code[], std::size_t size, simplecpp::OutputList * const outputList)
{
